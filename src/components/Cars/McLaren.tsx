...
Command: npx gltfjsx@6.1.11 public/models/McLaren/McLaren.gltf -t
...
type GLTFResult = GLTF & {
  nodes: {
    Rim_RF1_SUB1_Details_0: THREE.Mesh;
    Rim_RF1_SUB0_Rim_0: THREE.Mesh;
    Tyre_RF_2_Tyre_0: THREE.Mesh;
    g_Susp_Hub_RF_SUB1_Brake_Caliper_0: THREE.Mesh;
    g_Susp_Hub_RF_SUB0_Mechanicals_0: THREE.Mesh;
    g_Susp_Hub_RF_SUB2_Details_0: THREE.Mesh;
    g_Bumper_F_SUB0_Carbon_Mult50_0: THREE.Mesh;
    g_Bumper_F_SUB1_Matte_Black_0: THREE.Mesh;
    Brake_Disk_RR_2_Brake_Disk_0: THREE.Mesh;
    LIGHT_BRAKE_3_2_Taillights_0: THREE.Mesh;
    LIGHT_BRAKE_REAR_2_Taillights_0: THREE.Mesh;
    LIGHT_BRAKE_2_2_Taillights_0: THREE.Mesh;
    LIGHT_BRAKE_0_2_Taillights_0: THREE.Mesh;
    LIGHT_BRAKE_1_2_Taillights_0: THREE.Mesh;
    g_Susp_ALever_Top_LR_2_Mechanicals_0: THREE.Mesh;
    g_Susp_ALever_Top_RR_2_Mechanicals_0: THREE.Mesh;
    Rim_LR1_SUB1_Details_0: THREE.Mesh;
    Rim_LR1_SUB0_Rim_0: THREE.Mesh;
    Tyre_LR_2_Tyre_0: THREE.Mesh;
    g_Susp_ALever_Btm_LF_2_Mechanicals_0: THREE.Mesh;
    polymsh_extracted12_2_Windows_alpha_0: THREE.Mesh;
    g_Window_B_SUB1_Windows_0: THREE.Mesh;
    g_Window_B_SUB0_Windows_alpha_0: THREE.Mesh;
    g_Susp_Hub_LF_SUB1_Brake_Caliper_0: THREE.Mesh;
    g_Susp_Hub_LF_SUB0_Mechanicals_0: THREE.Mesh;
    g_Susp_Hub_LF_SUB2_Details_0: THREE.Mesh;
    Rim_LF1_SUB1_Details_0: THREE.Mesh;
    Rim_LF1_SUB0_Rim_0: THREE.Mesh;
    Tyre_LF_2_Tyre_0: THREE.Mesh;
    polymsh_detached93_2_INT_Decals_REF_spec_0: THREE.Mesh;
    Cylinder7_SUB0_INT_Decals_REF_GLOSS_0: THREE.Mesh;
    Cylinder7_SUB1_INT_Decals_REF_spec_0: THREE.Mesh;
    polymsh6_2_INT_Decals_REF_GLOSS_0: THREE.Mesh;
    GEO_DOOR_L_SUB5_INT_Decals_REF_spec_0: THREE.Mesh;
    GEO_DOOR_L_SUB8_INT_Decals_FLAT_0: THREE.Mesh;
    GEO_DOOR_L_SUB3_INT_Velvet_0: THREE.Mesh;
    GEO_DOOR_L_SUB4_INT_PLASTIC_Speakers_0: THREE.Mesh;
    GEO_DOOR_L_SUB0_INT_carbon_0: THREE.Mesh;
    GEO_DOOR_L_SUB7_INT_METAL_Aluminium_0: THREE.Mesh;
    GEO_DOOR_L_SUB2_INT_PLASTIC_Black_0: THREE.Mesh;
    GEO_DOOR_L_SUB6_INT_PLASTIC_Rubber_0: THREE.Mesh;
    GEO_DOOR_L_SUB1_Matte_Black_0: THREE.Mesh;
    GEO_DOOR_L_SUB9_INT_Decals_REF_AT_GLOSS_0: THREE.Mesh;
    polymsh_extracted_SUB0_Windows_alpha_0: THREE.Mesh;
    polymsh_extracted_SUB1_Windows_0: THREE.Mesh;
    GEO_DOOR_RR_SUB4_Mirror_0: THREE.Mesh;
    GEO_DOOR_RR_SUB3_Windows_0: THREE.Mesh;
    GEO_DOOR_RR_SUB2_Windows_alpha_0: THREE.Mesh;
    GEO_DOOR_RR_SUB5_Carbon_Mult50_0: THREE.Mesh;
    GEO_DOOR_RR_SUB1_Carpaint_Black_0: THREE.Mesh;
    GEO_DOOR_RR_SUB0_Carpaint_0: THREE.Mesh;
    polymsh_detached94_2_INT_Decals_REF_spec_0: THREE.Mesh;
    Cylinder6_SUB0_INT_Decals_REF_GLOSS_0: THREE.Mesh;
    Cylinder6_SUB1_INT_Decals_REF_spec_0: THREE.Mesh;
    polymsh54_2_INT_Decals_REF_GLOSS_0: THREE.Mesh;
    GEO_DOOR_R1_SUB7_INT_Decals_REF_spec_0: THREE.Mesh;
    GEO_DOOR_R1_SUB6_INT_Decals_FLAT_0: THREE.Mesh;
    GEO_DOOR_R1_SUB4_INT_Velvet_0: THREE.Mesh;
    GEO_DOOR_R1_SUB5_INT_PLASTIC_Speakers_0: THREE.Mesh;
    GEO_DOOR_R1_SUB2_INT_carbon_0: THREE.Mesh;
    GEO_DOOR_R1_SUB0_INT_PLASTIC_Black_0: THREE.Mesh;
    GEO_DOOR_R1_SUB1_INT_PLASTIC_Rubber_0: THREE.Mesh;
    GEO_DOOR_R1_SUB3_Matte_Black_0: THREE.Mesh;
    GEO_DOOR_R1_SUB8_INT_Decals_REF_AT_GLOSS_0: THREE.Mesh;
    polymsh_extracted11_SUB0_Windows_alpha_0: THREE.Mesh;
    polymsh_extracted11_SUB1_Windows_0: THREE.Mesh;
    polymsh5_SUB2_Mirror_0: THREE.Mesh;
    polymsh5_SUB4_Windows_0: THREE.Mesh;
    polymsh5_SUB5_Windows_alpha_0: THREE.Mesh;
    polymsh5_SUB3_Carbon_Mult50_0: THREE.Mesh;
    polymsh5_SUB1_Carpaint_Black_0: THREE.Mesh;
    polymsh5_SUB0_Carpaint_0: THREE.Mesh;
    Cylinder5_2_INT_Decals_REF_spec_0: THREE.Mesh;
    Cylinder4_2_INT_Decals_REF_spec_0: THREE.Mesh;
    GEO_PAD_L_SUB1_INT_Decals_FLAT_0: THREE.Mesh;
    GEO_PAD_L_SUB0_INT_carbon_0: THREE.Mesh;
    GEO_PAD_R_SUB1_INT_Decals_FLAT_0: THREE.Mesh;
    GEO_PAD_R_SUB0_INT_carbon_0: THREE.Mesh;
    GEO_STEER1_SUB4_INT_Decals_REF_GLOSS_0: THREE.Mesh;
    GEO_STEER1_SUB6_INT_Decals_REF_spec_0: THREE.Mesh;
    GEO_STEER1_SUB7_INT_Decals_FLAT_0: THREE.Mesh;
    GEO_STEER1_SUB1_INT_Skin_A_0: THREE.Mesh;
    GEO_STEER1_SUB0_INT_Velvet_0: THREE.Mesh;
    GEO_STEER1_SUB2_INT_carbon_0: THREE.Mesh;
    GEO_STEER1_SUB3_INT_METAL_Aluminium_0: THREE.Mesh;
    GEO_STEER1_SUB5_INT_PLASTIC_Black_0: THREE.Mesh;
    GEO_STEER1_SUB8_INT_Cuciture_0: THREE.Mesh;
    polymsh_extracted10_2_Clear_Glass_0: THREE.Mesh;
    LED_CHARGE_0_2_INT_DISPLAY_0: THREE.Mesh;
    LED_CHARGE_1_2_INT_DISPLAY_0: THREE.Mesh;
    LED_CHARGE_2_2_INT_DISPLAY_0: THREE.Mesh;
    LED_CHARGE_3_2_INT_DISPLAY_0: THREE.Mesh;
    LED_FUEL_0_2_INT_DISPLAY_0: THREE.Mesh;
    LED_FUEL_1_2_INT_DISPLAY_0: THREE.Mesh;
    LED_FUEL_2_2_INT_DISPLAY_0: THREE.Mesh;
    LED_FUEL_3_2_INT_DISPLAY_0: THREE.Mesh;
    GEO_Seats_SUB5_INT_Decals_REF_GLOSS_0: THREE.Mesh;
    GEO_Seats_SUB4_INT_Decals_REF_spec_0: THREE.Mesh;
    GEO_Seats_SUB0_INT_Skin_A_0: THREE.Mesh;
    GEO_Seats_SUB1_INT_Velvet_0: THREE.Mesh;
    GEO_Seats_SUB2_INT_carbon_0: THREE.Mesh;
    GEO_Seats_SUB3_INT_PLASTIC_Black_0: THREE.Mesh;
    GEO_Seats_SUB6_INT_Cuciture_0: THREE.Mesh;
    CINTURE_OFF_SUB1_INT_Decals_REF_spec_0: THREE.Mesh;
    CINTURE_OFF_SUB0_IN_Cinture_0: THREE.Mesh;
    CINTURE_OFF_SUB2_INT_METAL_Aluminium_0: THREE.Mesh;
    CINTURE_ON_SUB2_INT_Decals_REF_GLOSS_0: THREE.Mesh;
    CINTURE_ON_SUB0_INT_Decals_REF_spec_0: THREE.Mesh;
    CINTURE_ON_SUB1_IN_Cinture_0: THREE.Mesh;
    polymsh_SUB9_INT_DISPLAY_0: THREE.Mesh;
    polymsh_SUB2_INT_Decals_REF_GLOSS_0: THREE.Mesh;
    polymsh_SUB7_INT_Decals_REF_spec_0: THREE.Mesh;
    polymsh_SUB10_Mirror_0: THREE.Mesh;
    polymsh_SUB11_INT_Decals_FLAT_0: THREE.Mesh;
    polymsh_SUB8_INT_Carpet_0: THREE.Mesh;
    polymsh_SUB5_INT_Velvet_0: THREE.Mesh;
    polymsh_SUB1_INT_carbon_0: THREE.Mesh;
    polymsh_SUB6_INT_METAL_Aluminium_0: THREE.Mesh;
    polymsh_SUB0_INT_PLASTIC_Black_0: THREE.Mesh;
    polymsh_SUB4_INT_PLASTIC_Rubber_0: THREE.Mesh;
    polymsh_SUB3_Matte_Black_0: THREE.Mesh;
    polymsh_SUB12_INT_Decals_REF_AT_GLOSS_0: THREE.Mesh;
    DRS_Tag_2_2_INT_DISPLAY_0: THREE.Mesh;
    DRS_Tag_1_2_INT_DISPLAY_0: THREE.Mesh;
    DRS_Tag_0_2_INT_DISPLAY_0: THREE.Mesh;
    IPAS_Tag_2_2_INT_DISPLAY_0: THREE.Mesh;
    IPAS_Tag_1_2_INT_DISPLAY_0: THREE.Mesh;
    IPAS_Tag_0_2_INT_DISPLAY_0: THREE.Mesh;
    IPAS_Tag_3_2_INT_DISPLAY_0: THREE.Mesh;
    DRS_Tag_3_2_INT_DISPLAY_0: THREE.Mesh;
    LED_BATTERY_0_2_INT_DISPLAY_0: THREE.Mesh;
    LED_BATTERY_1_2_INT_DISPLAY_0: THREE.Mesh;
    LED_BATTERY_2_2_INT_DISPLAY_0: THREE.Mesh;
    LED_BATTERY_3_2_INT_DISPLAY_0: THREE.Mesh;
    LED_WATER_0_2_INT_DISPLAY_0: THREE.Mesh;
    LED_WATER_1_2_INT_DISPLAY_0: THREE.Mesh;
    LED_WATER_2_2_INT_DISPLAY_0: THREE.Mesh;
    LED_WATER_3_2_INT_DISPLAY_0: THREE.Mesh;
    LED_OIL_0_2_INT_DISPLAY_0: THREE.Mesh;
    LED_OIL_1_2_INT_DISPLAY_0: THREE.Mesh;
    LED_OIL_2_2_INT_DISPLAY_0: THREE.Mesh;
    LED_OIL_3_2_INT_DISPLAY_0: THREE.Mesh;
    g_Susp_Hub_RR_SUB1_Brake_Caliper_0: THREE.Mesh;
    g_Susp_Hub_RR_SUB0_Mechanicals_0: THREE.Mesh;
    g_Susp_Hub_RR_SUB2_Details_0: THREE.Mesh;
    LIGHT_0_2_Headlights_0: THREE.Mesh;
    LIGHT_1_2_Headlights_0: THREE.Mesh;
    g_Susp_ALever_Btm_LR_2_Mechanicals_0: THREE.Mesh;
    g_Wing_Guide_SUB0_Chrome_0: THREE.Mesh;
    g_Wing_Guide_SUB2_Plastics_0: THREE.Mesh;
    g_Wing_Guide_SUB1_Details_0: THREE.Mesh;
    g_Wing_Turn_SUB0_Chrome_0: THREE.Mesh;
    g_Wing_Turn_SUB1_Plastics_0: THREE.Mesh;
    g_Wing_SUB1_Chrome_0: THREE.Mesh;
    g_Wing_SUB3_Details_0: THREE.Mesh;
    g_Wing_SUB2_Carpaint_0: THREE.Mesh;
    g_Wing_SUB0_Matte_Black_0: THREE.Mesh;
    GEO_frontFender_2_Carpaint_0: THREE.Mesh;
    g_Susp_ALever_Top_LF_2_Mechanicals_0: THREE.Mesh;
    g_Susp_ALever_Btm_RR_2_Mechanicals_0: THREE.Mesh;
    g_Susp_Hub_LR_SUB1_Brake_Caliper_0: THREE.Mesh;
    g_Susp_Hub_LR_SUB0_Mechanicals_0: THREE.Mesh;
    g_Susp_Hub_LR_SUB2_Details_0: THREE.Mesh;
    g_Susp_ALever_Btm_RF_2_Mechanicals_0: THREE.Mesh;
    g_Diffuser_2_INT_carbon_0: THREE.Mesh;
    Brake_Disk_LF_2_Brake_Disk_0: THREE.Mesh;
    GEO_WIPER3_2_Plastics_0: THREE.Mesh;
    polymsh_detached_2_Plastics_0: THREE.Mesh;
    GEO_WIPER2_2_Plastics_0: THREE.Mesh;
    GEO_WIPER1_2_Plastics_0: THREE.Mesh;
    g_Body_SUB6_Chrome_0: THREE.Mesh;
    g_Body_SUB7_Clear_Glass_0: THREE.Mesh;
    g_Body_SUB3_Plastics_0: THREE.Mesh;
    g_Body_SUB13_Taillights_0: THREE.Mesh;
    g_Body_SUB0_Windows_0: THREE.Mesh;
    g_Body_SUB12_Mechanicals_0: THREE.Mesh;
    g_Body_SUB10_Details_0: THREE.Mesh;
    g_Body_SUB4_Carpaint_Black_0: THREE.Mesh;
    g_Body_SUB5_Carbon_Mult50_0: THREE.Mesh;
    g_Body_SUB1_Carpaint_Black_0: THREE.Mesh;
    g_Body_SUB2_Carpaint_0: THREE.Mesh;
    g_Body_SUB11_Matte_Black_0: THREE.Mesh;
    g_Body_SUB9_Grid2_0: THREE.Mesh;
    g_Body_SUB8_Grid1_Mult70_0: THREE.Mesh;
    GEO_HOOD_SUB2_Details_0: THREE.Mesh;
    GEO_HOOD_SUB0_Carpaint_0: THREE.Mesh;
    GEO_HOOD_SUB1_Matte_Black_0: THREE.Mesh;
    Brake_Disk_RF_2_Brake_Disk_0: THREE.Mesh;
    Rim_RR1_SUB1_Details_0: THREE.Mesh;
    Rim_RR1_SUB0_Rim_0: THREE.Mesh;
    Tyre_RR_2_Tyre_0: THREE.Mesh;
    g_Susp_ALever_Top_RF_2_Mechanicals_0: THREE.Mesh;
    Brake_Disk_LR_2_Brake_Disk_0: THREE.Mesh;
    polymsh_detached73_SUB0_Windows_0: THREE.Mesh;
    polymsh_detached73_SUB1_Windows_alpha_0: THREE.Mesh;
  };
  materials: {
    ...
    Mechanicals: THREE.MeshStandardMaterial;
    Carbon_Mult50: THREE.MeshStandardMaterial;
    Matte_Black: THREE.MeshStandardMaterial;
    Brake_Disk: THREE.MeshStandardMaterial;
    Taillights: THREE.MeshStandardMaterial;
    Windows_alpha: THREE.MeshPhysicalMaterial;
    Windows: THREE.MeshStandardMaterial;
    INT_Decals_REF_spec: THREE.MeshStandardMaterial;
    INT_Decals_REF_GLOSS: THREE.MeshStandardMaterial;
    INT_Decals_FLAT: THREE.MeshStandardMaterial;
    INT_Velvet: THREE.MeshStandardMaterial;
    INT_PLASTIC_Speakers: THREE.MeshStandardMaterial;
    INT_carbon: THREE.MeshStandardMaterial;
    INT_METAL_Aluminium: THREE.MeshStandardMaterial;
    INT_PLASTIC_Black: THREE.MeshStandardMaterial;
    INT_PLASTIC_Rubber: THREE.MeshStandardMaterial;
    INT_Decals_REF_AT_GLOSS: THREE.MeshStandardMaterial;
    Mirror: THREE.MeshStandardMaterial;
    Carpaint_Black: THREE.MeshStandardMaterial;
    Carpaint: THREE.MeshStandardMaterial;
    INT_Skin_A: THREE.MeshStandardMaterial;
    INT_Cuciture: THREE.MeshStandardMaterial;
    Clear_Glass: THREE.MeshPhysicalMaterial;
    INT_DISPLAY: THREE.MeshStandardMaterial;
    IN_Cinture: THREE.MeshStandardMaterial;
    INT_Carpet: THREE.MeshStandardMaterial;
    Headlights: THREE.MeshStandardMaterial;
    Chrome: THREE.MeshStandardMaterial;
    Plastics: THREE.MeshStandardMaterial;
    Grid2: THREE.MeshStandardMaterial;
    Grid1_Mult70: THREE.MeshStandardMaterial;
  };
};

export const McLaren = (props: JSX.IntrinsicElements['group']) => {
  const { nodes, materials } = useGLTF('./models/McLaren/car2.gltf') as GLTFResult;
      ...
      <group rotation={[-Math.PI / 2, 0, 0]} scale={2.75}>
        <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
          ...
          <group position={[-18.1, 49.45, 8.91]} rotation={[-3.06, -1.13, 2.87]}>
            ...
            <mesh geometry={nodes.GEO_DOOR_RR_SUB1_Carpaint_Black_0.geometry}>
            ...
            <mesh geometry={nodes.GEO_DOOR_RR_SUB0_Carpaint_0.geometry}>
              <meshStandardMaterial
                color={carColor.color}
                roughness={carTexture.roughness}
                metalness={carTexture.metalness}
...
useGLTF.preload('./models/McLaren/car2.gltf');
